...
(1, 1, '2018-10-08', '', 'Active'),
(61, 1, '2017-10-13', '', 'Active'),
(62, 1, '2017-10-13', '', 'Active'),
(81, 52, '2018-01-22', '', 'Active'),
(82, 53, '2018-01-22', '', 'Active'),
(92, 63, '2018-01-22', '', 'Active'),
(128, 99, '2018-01-23', '', 'Active');
...
INSERT INTO `consultation` (`consultation_id`, `infant_id`, `date`, `weight`, `height`, `pulse_rate`, `heart_rate`) VALUES
...
INSERT INTO `feedback` (`feedback_id`, `first_name`, `last_name`, `email`, `phone`, `company`, `message`) VALUES
(1, 'guccigang', 'guccigang', 'guccigang', 'guccigang', 'guccigang', 'guccigang'),
(2, 'feedback_result', 'feedback_result', 'feedback_result', 'feedback_result', 'feedback_result', 'feedback_result');
...
INSERT INTO `infant_info` (`infant_id`, `patient_ID`, `infant_first_name`, `infant_last_name`, `gravida`, `para`, `gender`, `time_of_birth`, `infant_date_of_birth`, `weight`, `length`, `head_circumference`, `chest_circumference`) VALUES
(1, 1, 'ABCD', 'Reyes', '', '', '', '7:16', '2017-10-08', '', '', '', '');
...
(8, 1, 1, '2017-10-11', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', '1', '1', '1', '1', '', 'Spontaneous', '1', '2017-10-27', 'No', 'No', 'No', 'No', 'No', 'No'),
...
(7, 53, 'Enriquez.Mike', '12345'),
(17, 63, 'patient_ID.patient_ID', '12345'),
(53, 99, 'Hwang .Tiffany', '12345');
...
INSERT INTO `patient_info` (`patient_ID`, `last_name`, `given_name`, `middle_initial`, `occupation`, `date_of_birth`, `contact_num`, `street_no`, `brgy`, `city`, `emergency_contact_name`, `emergency_contact_num`, `emergency_contact_address`, `date_registered`) VALUES
...
--
ALTER TABLE `case`
  MODIFY `case_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
--
...
--
ALTER TABLE `infant_info`
  MODIFY `infant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `patient_info`
  MODIFY `patient_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
--
